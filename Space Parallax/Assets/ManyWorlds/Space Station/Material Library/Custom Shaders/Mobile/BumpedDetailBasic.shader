...
/////// Diffuse:
                ...
                float3 diffuseColor = (_DiffuseMain_var.rgb*_DiffuseDetail_var.rgb);
...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float4 _DiffuseMain_var = tex2D(_DiffuseMain,TRANSFORM_TEX(i.uv0, _DiffuseMain));
                float4 _DiffuseDetail_var = tex2D(_DiffuseDetail,TRANSFORM_TEX(i.uv0, _DiffuseDetail));
                float3 diffColor = (_DiffuseMain_var.rgb*_DiffuseDetail_var.rgb);
                float node_400 = (_DiffuseMain_var.a*_DiffuseDetail_var.a*_SpecularIntensity);
