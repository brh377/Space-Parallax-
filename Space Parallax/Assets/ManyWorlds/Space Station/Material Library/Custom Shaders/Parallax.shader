...
/// Final Color:
        ...
        Pass {
            ...
            float4 frag(VertexOutput i) : SV_Target {
                ...
                float node_46 = 0.8;
                float3 specColor = float3(node_46,node_46,node_46);
